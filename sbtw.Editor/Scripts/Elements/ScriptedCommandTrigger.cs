...
{
    public class ScriptedCommandTrigger : CommandTrigger, IScriptedCommandTimelineGroup
    {
        public CommandTimeline<Vector2> Move = new CommandTimeline<Vector2>();

        public ScriptedCommandTrigger(string triggerName, double startTime, double endTime, int groupNumber)
