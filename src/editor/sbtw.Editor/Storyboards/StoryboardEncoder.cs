...
{
    public class StoryboardEncoder : ScriptRunner<StringBuilder, StringBuilder>
    {
        ...
        protected override StringBuilder HandleAnimation(StringBuilder context, ScriptedAnimation animation)
        ...
        protected override StringBuilder HandleSample(StringBuilder context, ScriptedSample sample)
            => Samples.AppendLine($"Sample,{sample.StartTime},{(int)sample.Layer},\"{sample.Path}\",{sample.Volume}");

        protected override StringBuilder HandleSprite(StringBuilder context, ScriptedSprite sprite)
        ...
        protected override StringBuilder HandleVideo(StringBuilder context, ScriptedVideo video)
