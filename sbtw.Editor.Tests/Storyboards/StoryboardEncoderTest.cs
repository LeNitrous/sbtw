...
{
    public class StoryboardEncoderTest : ScriptRunnerTest<StoryboardEncoder, StringBuilder>
    {
        protected override StoryboardEncoder CreateRunner() => new StoryboardEncoder();
        ...
        private IEnumerable<string> generate(Action<Script> perform = null) => Generate(perform).ToString().TrimEnd().Split(Environment.NewLine);
    }
}
